...
public class SplitTest
{
    ...
    public void Test()
    {
        ...
        Assert.IsFalse(split2.IsEmpty);
        Assert.AreEqual(0, split2.IsTrivial());
        ...
        Assert.Throws<ArgumentOutOfRangeException>(() => new Split(3, -1));
    }
    ...
    public void Test3()
    {
        ...
        Assert.AreEqual(-1, split3.IsTrivial());
        ...
        Assert.AreEqual(-1, split4.IsTrivial());
        ...
        Assert.AreEqual(-1, split5.IsTrivial());
        ...
        Assert.AreEqual(-1, split6.IsTrivial());
        ...
        Assert.AreEqual(4, split7.LeafCount);
        Assert.IsTrue(split7.IsEmpty);
        Assert.AreEqual(-1, split7.IsTrivial());
        Assert.IsTrue(split7.IsSameSide(0, 1));
        Assert.IsTrue(split7.IsSameSide(2, 3));
    }
    ...
    public void FromChildrenTest()
    {
        ...
        Assert.AreEqual(3, split.IsTrivial());
        Assert.IsTrue(split.IsSameSide(1, 2));
