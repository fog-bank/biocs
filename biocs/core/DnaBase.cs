...
public readonly struct DnaBase : IEquatable<DnaBase>
{
    ...
    /// </summary>
    public static DnaBase Adenine => new(DnaBases.Adenine);

    /// <summary>
    /// Gets the <see cref="DnaBase"/> instance for guanine.
    /// </summary>
    public static DnaBase Guanine => new(DnaBases.Guanine);

    /// <summary>
    /// Gets the <see cref="DnaBase"/> instance for thymine.
    /// </summary>
    public static DnaBase Thymine => new(DnaBases.Thymine);

    /// <summary>
    /// Gets the <see cref="DnaBase"/> instance for cytosine.
    /// </summary>
    public static DnaBase Cytosine => new(DnaBases.Cytosine);
    ...
    /// </summary>
    public static DnaBase Any => new(DnaBases.Any);
    ...
    public DnaBase ToUpper() => new(ToUpper(Code));
...
internal sealed class DnaBaseParser
{
